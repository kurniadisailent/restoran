...
<div class="card">
  ...
  <div class="card-body">
    <form action="{{route('waiteraccount.update',['waiteraccount'=>$data->id_waiter])}}" method="POST"  enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row d-flex justify-content-center">
      <div class="col-md-2 mt-4 mb-2">
        <img src="{{url('assets/foto_waiter/'.$data->file_foto_waiter)}}" width="150" class="img-thumbnail mr-3" align="left" id="preview">
      ...
      <div class="col-md-8">
        <label>Masukan Foto Karyawan</label>
          ...
          <div class="form-group">
            ...
            <input type="text" name="nama_waiter" value="{{ old('nama_waiter',$data->nama_waiter) }}" class="form-control" required>
          </div>
        </div>
