...
<div class="card">
  ...
  <div class="card-body">
    <form action="{{route('kasiraccount.store')}}" method="POST"  enctype="multipart/form-data">
    @csrf
        ...
        <label>Masukan Foto Karyawan</label>
          <div class="form-group">
            <div class="custom-file">
              <input name="file_foto_kasir" type="file" accept="image/x-png,image/gif,image/jpeg" class="form-control" id="inputGambar_menu" placeholder=" masukan file gambar buku" name="gambar" required>
          ...
          <div class="form-group">
            ...
            <input type="text" name="nama_kasir" value="" class="form-control" required>
          </div>
        </div>
