                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="nav nav-tabs mb-3 col-md-12">
                            <li class="nav-item">
                                <a class="nav-link {{ $kat == 'Semua' ? 'active':'' }}" href="{{route('adminorder.kategori',['kategori' => 'Semua'])}}"><i class="fas fa-th-large"></i> Semua </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ $kat == 'Makanan' ? 'active':'' }}" href="{{route('adminorder.kategori',['kategori' => 'Makanan'])}}"><i class="fas fa-utensils"></i> Makanan </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ $kat == 'Minuman' ? 'active':'' }}" href="{{route('adminorder.kategori',['kategori' => 'Minuman'])}}"><i class="fas fa-wine-glass"></i> Minuman </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ $kat == 'Dessert' ? 'active':'' }}" href="{{route('adminorder.kategori',['kategori' => 'Dessert'])}}"><i class="fas fa-ice-cream"></i> Dessert </a>
                            </li>
                        </ul>
                    </div>
                    <!-- END-KATEGORI -->
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="">
                                                <form action="{{route('adminadminentriorder.tambahmenu.proses')}}" method="POST">
                                                @method('POST')
                                                @csrf
                                                    <div class="row">
                                                        <div class="col-md-5">
