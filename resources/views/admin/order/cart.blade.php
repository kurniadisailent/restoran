        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="">
                                                <form action="{{route('adminorder.ubah')}}" method="POST">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-5">
                    ...
                    <form action="{{route('adminorder.prosses')}}" method="POST">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                <a href="{{route('adminorder.index')}}" class="btn col-md-5 btn-success mr-2 text-white">Kembali Ke Menu</a>
                            </div>
                            ...
                            <div class="col-md-1"></div>
                            <a href="#" data-id="{{ route('adminorder.reset',['id_petugas'=>\Auth::guard('admin')->user()->id_admin])}}" class="btn btn-danger confirm_script ml-2">
                                Kosongkan Keranjang
                            </a>
                        </div>
                    </form>
