        ...
        <div class="col-md-12">
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <!-------------------------------------------------------- HR --------------------------------------------------------> <hr>
                        <ul class="nav nav-tabs mb-3 col-md-12">
                            <li class="nav-item">
                                <a class="nav-link {{ $kat == 'Semua' ? 'active':'' }}" href="{{route('waiterorder.kategori',['kategori' => 'Semua'])}}"><i class="fas fa-th-large"></i> Semua </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ $kat == 'Makanan' ? 'active':'' }}" href="{{route('waiterorder.kategori',['kategori' => 'Makanan'])}}"><i class="fas fa-utensils"></i> Makanan </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ $kat == 'Minuman' ? 'active':'' }}" href="{{route('waiterorder.kategori',['kategori' => 'Minuman'])}}"><i class="fas fa-wine-glass"></i> Minuman </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ $kat == 'Dessert' ? 'active':'' }}" href="{{route('waiterorder.kategori',['kategori' => 'Dessert'])}}"><i class="fas fa-ice-cream"></i> Dessert </a>
                            </li>
                        </ul>
                    </div>
                    <!-- END-KATEGORI -->
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="">
                                                <form action="{{route('waiterorder.order')}}" method="POST">
                                                @csrf
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="row d-flex justify-content-center">
                                                                <button type="button" class="btn btn-secondary col-md-4 text-center mb-2 mr-md-2" data-dismiss="modal">Cancel</button>
                                                                <button type="submit" class="btn btn-danger col-md-4 text-center mb-2" data-toggle="modal">Order</button>
                                                            </div>      
                                                        </div>   
                                                    </div>
                                                </form>
                ...
                <!-- Button Keranjang -->
                <div class="d-flex justify-content-center">
                    <a href="{{route('waiterorder.cart',['id_petugas'=>\Auth::guard('waiter')->user()->id_waiter])}}" class="btn btn-danger mb-4 "> <h5 class="mt-2"><i class="fas fa-shopping-cart" style="font-size : 20px;"></i> Lihat keranjang Untuk melanjutkan</h5></a>
                </div>
            </div>
        </div>
    </div>
