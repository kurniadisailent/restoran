...
<div class="section-body">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{route('waiterwaiterentriorder.tambahmenu',['kode_order'=>$kode_order])}}" class="btn btn-icon icon-left btn-primary mb-3 px-3"><i class="fas fa-plus"></i> Tambah Menu Baru</a>
                    @if (session('sukses'))
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="">
                                                <form action="{{route('waiterwaiterentriorder.tambahjml')}}" method="POST">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-5">
                    ...
                    @if($status == 'BELUM_BAYAR')
                    <form action="{{route('waiterwaiterentriorder.update')}}" method="POST">
                        @else
                        <form action="{{route('waiterwaiterentriorder.proses')}}" method="POST">
                            @endif
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-3">
                                    <a href="{{route('waiterentriorder.index')}}" class="btn col-md-5 btn-secondary">Kembali</a>
                                </div>
