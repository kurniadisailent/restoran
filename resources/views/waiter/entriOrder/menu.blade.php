    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mt-3">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="">
                                                <form action="{{route('waiterwaiterentriorder.tambahmenu.proses')}}" method="POST">
                                                @method('POST')
                                                @csrf
                                                    <div class="row">
                                                        <div class="col-md-5">
                ...
                <!-- Button Keranjang -->
                <div class="d-flex justify-content-center">
                    <a href="{{route('waiterorder.cart',['id_petugas'=>\Auth::guard('waiter')->user()->id_waiter])}}" class="btn btn-primary mb-4 "> <h5 class="mt-2"><i class="fas fa-shopping-cart" style="font-size : 20px;"></i> Lihat keranjang Untuk melanjutkan</h5></a>
                </div>
            </div>
        </div>
    </div>
