...
<div class="card">
  ...
  <div class="card-body">
    <form action="{{route('waiter.pengaturanakun.edit')}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-8">
          ...
          <div class="form-group">
            ...
            <input type="text" name="nama_waiter" value="{{$data->nama_waiter}}" class="form-control" required>
          </div>
        </div>
