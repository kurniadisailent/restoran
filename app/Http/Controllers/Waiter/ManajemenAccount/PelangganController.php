...
namespace App\Http\Controllers\Waiter\ManajemenAccount;
...
class PelangganController extends Controller
{
    ...
    public function index(Request $request)
    {
        $data = DB::table('tbl_pelanggan')
            ...
            ->paginate(10);
        return view('waiter.pelanggan.index',['data'=>$data]);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('waiterpelangganaccount.create')->with('sukses','Data Berhasil di simpan !');
    }
    ...
    {
        return view('waiter.pelanggan.edit',['data'=>$pelangganaccount]);
    }
