...
namespace App\Http\Controllers\Kasir\ManajemenAccount;
...
class PelangganController extends Controller
{
    ...
    public function index(Request $request)
    {
        $data = DB::table('tbl_pelanggan')
            ...
            ->paginate(10);
        return view('kasir.pelanggan.index',['data'=>$data]);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kasirpelangganaccount.create')->with('sukses','Data Berhasil di simpan !');
    }
    ...
    {
        return view('kasir.pelanggan.edit',['data'=>$pelangganaccount]);
    }
